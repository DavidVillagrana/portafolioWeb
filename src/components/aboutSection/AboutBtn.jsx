...
const AboutBtn = () => {
  ...
  return (
    <a   /*Recuerda que tu curriculum o archivo .pdf tiene que estar dentro de la carpeta public para que el boton funcione de manera correcta */
      href="../../../public/Tu_Curriculum.pdf" /*Ruta donde estara tu curriculum para poder descargarlo */
      //download  //Una vez tengas el curriculum quita las // de la palabra download para habilitar la funcion de descarga
