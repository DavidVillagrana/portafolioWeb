...
const projectsFront = [
  /* {
    ...
    description: "Portafolio web profesional utilizando React y Tailwind.",
        ...
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-center mb-4">
            <span className="inline-block text-3xl md:text-4xl font-bold text-gray-300 underline transition-transform hover:scale-110 hover:text-cyan-300">
              Proyectos<span className="text-cyan-300"> Avanzados</span>
            </span>
          </h2>

          <p className="text-center text-gray-300 mb-12 max-w-2xl mx-auto">
            Aplicaciones más complejas y orientadas a la resolución de problemas
            reales, como sistemas de ventas, inventarios o gestión de datos
            empresariales. Estos proyectos combinan múltiples herramientas del
            stack full stack para crear productos escalables y funcionales,
            simulando entornos de producción.
          </p>
